...
function Stat({ icon: Icon, label, value, sub, tone = 'brand' }: { icon: ComponentType<{ className?: string }>; label: string; value: string; sub?: string; tone?: string }) {
...
export default function AdminOverview() {
  ...
  const statusEntries = Object.entries(o.statusCounts ?? {}) as [string, number][];
