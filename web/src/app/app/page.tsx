    ...
    <div className="space-y-10">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            {categories.map((c) => {
              ...
              return (
                <Link
                  key={c.id}
                  href={`/app/book?categoryId=${c.id}&slug=${c.slug}`}
      ...
      <section>
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link href="/app/bookings" className="inline-flex items-center gap-1 text-sm font-medium text-brand-600 hover:text-brand-700">
