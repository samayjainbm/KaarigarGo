        ...
        <div className="container-page grid items-center gap-12 py-16 lg:grid-cols-2 lg:py-24">
          <div className="animate-fade-up">
            ...
            <p className="mt-5 max-w-md text-lg text-slate-600">
              Electricians, plumbers, cleaners and more — background-verified, fairly priced, and
              tracked from request to done.
            </p>
        ...
        <div className="flex flex-col items-center justify-between gap-6 rounded-3xl border border-slate-200 bg-white p-10 text-center md:flex-row md:text-left">
          <div>
            ...
            <p className="mt-2 max-w-lg text-slate-500">
              Join KaarigarGo, get verified, and grow your business with steady local jobs, fair
              commissions, and on-time payouts.
            </p>
          </div>
          <Link
            href="/login"
